...
while(True):
    ...
    if(Your_password != sibashis.password()):
        ...
        if(chose_function == 1):
            ...
            Minutes=int(input("Enter the minute: "))
            format=input("PM or AM ?  (Notice- Please write in Capital letter)")
            sibashis.send_message(Group_name, message,Hours_format.Hoursformat(Hours,format),Minutes, 15)
            ...
            if(name in us.show_contact_list()):
                ...
                Minutes=int(input("Enter the minute: "))
                format=input("PM or AM ?  (Notice- Please write in Capital letter)")
                sibashis.send_message(Number_list[name],image,00,Minutes,25)
            else:
                number=input(f"Enter the number of {name}")
                us.adding_contact_list(name,number)
                print(us.show_contact_list())
                ...
                Minutes=int(input("Enter the minute: "))
                format=input("PM or AM ?  (Notice- Please write in Capital letter)")
                sibashis.send_message(Number_list[name],image,Hours_format.Hoursformat(Hours,format),Minutes,25)
